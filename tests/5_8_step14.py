"""
Ваша задача — создать функцию-замыкание create_dict.
Функция create_dict должна сохранять в себе в виде словаря все значения, которые ей будут переданы.
